  ...
  function() {
    ...
    cprequire(
      ...
      function(myMAxTGrbl) {
        ...
        console.log("Workspace / grbl just got loaded.", myMAxTGrbl);
        myMAxTGrbl.init();
      }
    );
  }
