# com-chilipeppr-MAxT-Grbl
A ChiliPeppr Workspace.



## ChiliPeppr Workspace / MAxT-Ggrbl
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-MAxT-Grbl |
| Name                  | Workspace / MAxT-Ggrbl |
| Description           | A ChiliPeppr Workspace. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/vincedovy/MAxT-Grbl/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/Cloud9User/Home Workspace |
| Github URL            | http://github.com/vincedovy/MAxT-Grbl |
| Test URL              | https://preview.c9users.io/Cloud9User/Home Workspace/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/vincedovy/MAxT-Grbl/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-MAxT-Grbl"], // the id you gave your workspace
      function(myMAxTGrbl) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / MAxT-Ggrbl just got loaded.", myMAxTGrbl);
        myMAxTGrbl.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-MAxT-Grbl"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / MAxT-Ggrbl"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/vincedovy/MAxT-Grbl/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/Cloud9User/Home Workspace"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/vincedovy/MAxT-Grbl"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://Home Workspace-Cloud9User.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
