...
cprequire_test(["inline:com-chilipeppr-MAxT-Grbl"], function(ws) {
...
cpdefine("inline:com-chilipeppr-MAxT-Grbl", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-MAxT-Grbl", // Make the id the same as the cpdefine id
        name: "Workspace / MAxT-Ggrbl", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace.`,
